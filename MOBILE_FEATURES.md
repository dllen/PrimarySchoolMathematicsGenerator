...
本项目已完成 UI 全面重设计（v3.0.0），移动端特性全面升级：

- **汉堡菜单**：顶栏右侧 ☰ 按钮，点击展开全屏 Sheet 导航
- **Sticky 底部按钮**：ActionBar 固定在底部，方便触控
- **≥ 44px 触控目标**：所有按钮、输入框最小高度 44px
- **2 列卡片网格**：移动端工作台卡片自动切换为 2 列布局
- **BaseSheet 组件**：iOS/Android 原生底部弹出体验
